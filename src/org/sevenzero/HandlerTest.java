...
public class HandlerTest extends Activity implements OnClickListener {
	...
	class EventHandler extends Handler {
		...
		public void handleMessage(Message msg) {
			...
			Log.d(TAG, "EventHandler what " + msg.what);
			Log.d(TAG, "EventHandler arg1 " + msg.arg1);
			Log.d(TAG, "EventHandler arg2 " + msg.arg2);
			switch (msg.what) {
			case 1:
...
//						noLooperThread.stop();
	...
	class OwnLooperThread extends Thread {
		...
		public void run() {
			...
			// 给自己发送消息
			Message msg = mOwnLooperThreadHandler
					.obtainMessage(3, 1, 1, msgobj);
